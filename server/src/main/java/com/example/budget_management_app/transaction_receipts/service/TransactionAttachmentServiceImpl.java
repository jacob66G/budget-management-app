...
import com.example.budget_management_app.common.service.S3StorageService;
import com.example.budget_management_app.transaction.domain.Transaction;
import com.example.budget_management_app.transaction.service.TransactionService;
import com.example.budget_management_app.transaction_receipts.common.AttachmentKeyProvider;
import com.example.budget_management_app.transaction_receipts.common.AttachmentValidator;
...
public class TransactionAttachmentServiceImpl implements TransactionAttachmentService {
    ...
    public ReceiptUploadUrlResponse getPresignedPutUrl(
        ...
        return ReceiptUploadUrlResponse.of(key, storageService.generatePresignedPutUrl(key, fileType, fileSize));
    }
