...
-- 3. ACCOUNTS
INSERT INTO accounts (id, name, balance, total_income, total_expense, account_status, account_type, currency, is_default, description, budget_type, budget, alert_threshold, created_at, icon_key, include_in_total_balance, user_id)
VALUES
    -- User 1
